...
import com.example.workaddict.Login.SessionCallback;
...
//        Util.saveContext(this);
        ...
        try {
            PackageInfo info = getPackageManager().getPackageInfo("com.example.workaddict", PackageManager.GET_SIGNATURES);
